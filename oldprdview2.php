...
<table width="1450" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="43">&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="3" valign="top"><div align="center" class="style1">Old Products Details </div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
		...
		else
		{
			...
			if($pid==$row[0])
				...
				echo "<tr bgcolor='#aabbcc'>
						...
						<td>$row[2]</td>
						<td align='center'>
							<form action='oldprdview2.php' method='post'>
  ...
  <td>&nbsp;</td>
	...
	?>&nbsp;</th>
      ...
      <tr>
        <th scope="row"><textarea disabled><?php echo $row[4]; ?></textarea>&nbsp;</th>
      </tr>
    </table>
	 </td>
    <td>&nbsp;</td>
