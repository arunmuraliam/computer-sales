...
if(document.form2.t1.value=="" || document.form1.t2.value=="" ||document.form1.t3.value=="" ||document.form1.t4.value==""
...
&nbsp;</p>
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td colspan="2" rowspan="3" valign="top"><form name="form2" onSubmit="return abc()" method="post" action="oldprdpaytocustomer3.php">
